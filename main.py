...
CONCRETE_HINT_NEWS = (
    "Сделай акцент на цифрах (1–2 ключевые метрики) и добавь блок **🧭 Что делать инвестору:** 2–3 пункта."
    "Используй ТОЛЬКО факты и цифры из блока «Содержание новости». "
    "Если исходник на английском — переведи ключевые формулировки на русский. "
    "Имена собственные и тикеры не переводить. Без домыслов. "
    "В конце добавь блок **🧭 Что делать инвестору:** 2–3 пункта, основанные на этих фактах."
)
